...
WIDTH, HEIGHT = 1366,750
RES = (WIDTH, HEIGHT)

FONT_SIZE = 19
alpha_value = randrange(30, 40, 5)

chars = ['d',"e","e","p","a","y","a","n"," ","t","h","a","k","r"]
#chars = ["1","0"]
#chars = ['+',"-",",","."," ","[","]","?",">","<",":",";","|","o"]

font = pygame.font.Font('font/comic.ttf', FONT_SIZE)
font_2 = pygame.font.Font('font/comic.ttf', FONT_SIZE - FONT_SIZE // 6)
font_3 = pygame.font.Font('font/comic.ttf', FONT_SIZE - FONT_SIZE // 3)
